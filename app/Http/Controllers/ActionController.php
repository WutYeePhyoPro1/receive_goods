...
class ActionController extends Controller
{
    ...
    public function search_doc(Request $request)
    {
        ...
        if ($type == "PO") {
            ...
            ---product_quantity,
            product_quantity_transfer as Qty,mp.product_unit_code
            ---, product_unit_pack
        ...
        if ($product) {
            ...
            try {
                if (in_array(getAuth()->branch_id, [17, 19, 20, 9])) {
                    ...
                    from	dblink('dbname=pro1_awms host = 43.231.64.170 port=5432 user=superadmin password=W151_mware@house241SvrMain',
                    '
