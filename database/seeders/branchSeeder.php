...
class branchSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Branch::factory()->create([ 'branch_name' =>'Ayetharyar','branch_code' => 'MM-109','branch_short_name'=>'ATY1']);
        ...
        Branch::factory()->create(['branch_name'=>'Da Nyin Gone','branch_code'=> 'MM-114','branch_short_name'=>'SPT1']);
