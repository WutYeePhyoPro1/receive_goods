            ...
            <form action="" method="POST">
                ...
                <div class="grid grid-cols-2 gap-5 my-5">
                    ...
                    <div class="flex flex-col px-10">
                        ...
                        <input type="number" name="employee_code" id="employee_code" class="mt-3 border-2 border-slate-600 rounded-lg ps-5 py-2 focus:border-b-4 focus:outline-none">
                        @error('employee_code')
                        <small class="text-rose-500 ms-1">{{ $message }}</small>
                    @enderror
                    </div>
                ...
                <div class="grid grid-cols-2 gap-5 my-5">
                    <div class="flex flex-col px-10">
                        ...
                        <input type="password" name="password" class="mt-3 border-2 border-slate-600 rounded-lg ps-5 py-2 focus:border-b-4 focus:outline-none">
                        @error('password')
                        <small class="text-rose-500 ms-1">{{ $message }}</small>
                    @enderror
                    </div>
