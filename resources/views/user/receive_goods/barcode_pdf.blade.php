...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .bar1 .barcode { height: 7.5mm; margin-top: .2mm; }
        ...
        .bar1 .date { margin-top: .1mm; font-size: 4.8pt; line-height: 5pt; }
        ...
        .bar1 .label.first > * { position: relative; left: -.8mm; }
        .bar1 .label.last > * { position: relative; left: .8mm; }
    ...
    <div class="sheet {{ $type === 2 ? 'bar2' : 'bar' . $type }} {{ $loop->last ? 'last' : '' }}">
        @foreach($page as $index => $unused)
            @php
                ...
                $top = ($type === 1 ? 1.5 : 3.217) + ($row * 10.245);
