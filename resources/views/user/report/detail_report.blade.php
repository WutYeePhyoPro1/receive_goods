    ...
    <div class="m-5">
        ...
        <div class="">
            <div class="">
                ...
                @endif
                <button type="button" class="bg-sky-400 text-white text-xl h-10 px-3 rounded-lg ms-4 mt-9 hover:bg-sky-600 hover:text-white" onclick="javascript:window.location.href='/detail_excel_export/{{ $driver->id}}'"><i class='bx bx-export'></i></button>
                <a href="/truck_detail_pdf/{{ $driver->id
                }}" target="_blank"><button type="button" class="bg-rose-400 text-white text-xl h-10 px-3 rounded-lg ms-4 mt-9 hover:bg-rose-600 hover:text-white"><i class='bx bxs-printer'></i></button></a>
            </div>
